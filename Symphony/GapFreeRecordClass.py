...
class GapFreeRecord( AbstractProtocol):
    '''Class for GapFreeRecord analysis'''

    def __init__( self, epoch_group_object, block_uuid, count):
        super( GapFreeRecord, self).__init__( epoch_group_object, block_uuid, count)
    ...
    def fetch_total_time( self):
        ...
        return self['recordTime']*numberOfAverages
