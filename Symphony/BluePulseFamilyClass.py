...
class BluePulseFamily( AbstractProtocol):
    '''Class for BluePulseFamily protocol analysis'''

    def __init__( self, epoch_group_object, block_uuid, count):
        super( BluePulseFamily, self).__init__( epoch_group_object, block_uuid, count)
        self.name = 'BluePulseFamily'
